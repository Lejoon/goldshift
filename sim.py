...
class Card:
    ...
    def mana(self):
        ...
        if self.name == 'Plains':
            return ['W']
        if self.name == 'Cinder Glade':
            return ['R', 'G']
        if self.name == 'Temple Garden':
            return ['W','G']
        if self.name == 'Steam Vents':
            return ['U', 'R']
        if self.name == 'Stomping Ground':
            return ['G', 'R']
        if self.name == 'Valakut, the Molten Pinnacle':
            return ['R']
        if self.name == 'Hallowed Fountain':
            return ['U', 'W']
